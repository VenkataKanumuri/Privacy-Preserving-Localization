...
def main():
    ...
    while (True):
        ...
        cv2.circle(frame, (265, 105), 5, (0, 255, 255), -1)
        cv2.circle(frame, (610, 105), 5, (0, 255, 255), -1)
        cv2.circle(frame, (265, 410), 5, (0, 255, 255), -1)
        cv2.circle(frame, (610, 410), 5, (0, 255, 255), -1)
    
        pts1 = np.float32([[265, 105],[610, 105],[265, 410],[610, 410]])
