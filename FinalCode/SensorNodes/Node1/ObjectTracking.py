...
def main():
    ...
    while (True):
        ...
        cv2.circle(frame, (90, 115), 5, (0, 255, 255), -1)
        cv2.circle(frame, (470, 115), 5, (0, 255, 255), -1)
        cv2.circle(frame, (100, 420), 5, (0, 255, 255), -1)
        cv2.circle(frame, (470, 420), 5, (0, 255, 255), -1)
    
        pts1 = np.float32([[90, 115],[470, 115],[100, 420],[470, 420]])
        ...
        # Predict
        settingCenter = [[maxLoc[0]], [maxLoc[1]]]
       
        # x&z coordinates of the laser (converting pixel2cm)
        corx = maxLoc[0] * 0.165            #106/640
        cory = maxLoc[1] * 0.165
