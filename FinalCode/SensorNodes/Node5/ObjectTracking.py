...
def main():
    ...
    while (True):
        ...
        cv2.circle(frame, (250, 380), 5, (0, 255, 255), -1)
        cv2.circle(frame, (580, 370), 5, (0, 255, 255), -1)
        cv2.circle(frame, (250, 50), 5, (0, 255, 255), -1)
        cv2.circle(frame, (580, 50), 5, (0, 255, 255), -1)
    
        pts1 = np.float32([[280, 380],[580, 370],[280, 50],[580, 50]])
